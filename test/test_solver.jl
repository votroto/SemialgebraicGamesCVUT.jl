...
@testset "Saddle Example 6.1 (IV) " begin
	@polyvar x[1:3] y[1:3]
	p = x[1]x[2]y[1]y[2] + x[2]x[3]y[2]y[3] + x[3]x[1]y[3]y[1] - x[1]^2*y[3]^2 - x[2]^2*y[1]^2 - x[3]^2*y[2]^2
	Sx = @set sum(x) == 1 && x[1] >= 0 && x[2] >= 0 && x[3] >= 0
	Sy = @set sum(y) == 1 && y[1] >= 0 && y[2] >= 0 && y[3] >= 0
...
@testset "Saddle Example 6.2 (II)  " begin
	@polyvar x[1:3] y[1:3]
	p = sum([(x[i]+y[i]) for i=1:3]) - prod([(x[i]-y[i]) for i=1:3])
	Sx = @set x[1] >= 0 && x[2] >= 0 && x[3] >= 0 && 1 - x[1] >= 0 && 1 - x[2] >= 0 && 1 - x[3] >= 0
	Sy = @set y[1] >= 0 && y[2] >= 0 && y[3] >= 0 && 1 - y[1] >= 0 && 1 - y[2] >= 0 && 1 - y[3] >= 0
...
@testset "Saddle Example 6.3 (II)  " begin
	@polyvar x[1:3] y[1:3]
	p = y'y - x'x + sum([(x[i]y[j] - x[j]y[i]) for i=1:3,j=1:3 if i<j])
	Sx = @set x[1]^2 <= 1 && x[2]^2 <= 1 && x[3]^2 <= 1
	Sy = @set y[1]^2 <= 1 && y[2]^2 <= 1 && y[3]^2 <= 1
...
@testset "Saddle Example 6.4 (I)  " begin
	@polyvar x[1:3] y[1:3]
	p = x[1]^3 + x[2]^3 + x[3]^3 + y[1]^3 + y[2]^3 + y[3]^3 + 2*(x[1]x[2]y[1]y[2] + x[1]x[3]y[1]y[3] + x[2]x[3]y[2]y[3])
	Sx = @set x'x == 1
	Sy = @set y'y == 1
